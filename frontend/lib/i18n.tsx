...
const dictionaries: Record<Locale, Record<string, string>> = {
  id: {
    ...
    "assessment.startNew": "Mulai Asesmen Baru",
    "done.title": "Asesmen Selesai",
    "done.message": "Terima kasih! Semua informasi yang dibutuhkan sudah terkumpul.",
  ...
  en: {
    ...
    "cta.new": "Start New",
    "start.template": "Assessment type",
    ...
    "done.message": "Thank you! We've collected all the information we need.",
